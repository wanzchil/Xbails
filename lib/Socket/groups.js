...
export const makeGroupsSocket = (config) => {
    ...
    const recordBlockedGroupJoin = (value) => {
        ...
        console.warn(`\x1b[33m[wanz-baileys] \u{1F6E1}  Blocked group-join attempt: ${value}\x1b[0m`);
        console.warn('\x1b[33m[wanz-baileys]     Not in the allowlist, so it was NOT sent to WhatsApp.\x1b[0m');
        console.warn('\x1b[33m[wanz-baileys]     Set { blockAutoJoinGroups: false } in your config to allow it.\x1b[0m');
    };
