...
<p align="center">
  <img src="https://raw.githubusercontent.com/wanzchil/teamo/main/mbut.jpg" alt="Thumbnail" />
</p>
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    url: "https://t.me/WanzzWangzaf",
    body: "Nak Tido",
    footer: "Footer",
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"Wanz\",\"url\":\"https://t.me/WanzzWangsaf\"}"
      }
    ],
...
const thanksFor = async () => {
  const credit = new Map([
    ...
    ["Wanz", "main source baileys ( maybe )"]
  ]);
